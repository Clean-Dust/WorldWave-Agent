...
| **Coding Engine** | `coding/` (PM 0.9) | Productized default path: coding-mode auto + orchestrator (map/grep/graph → edit → verify → circuit), steerable redirect, AutoCompact, require-test ON — see `docs/coding-engine.md` |
