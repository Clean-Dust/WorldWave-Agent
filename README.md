...
| **Coding Engine** | `coding/` (PM 0.8) | Default harness: code graph + repo map/grep, ACI symbol/patch edits with rollback, microcompact, deny-first policy, causal verify-before-commit, replan/prove — see `docs/coding-engine.md` |
