...
| **Coding Engine** | `coding/` (PM 0.10) | Live multi-turn path: mode + model route + orchestrator (map/grep/graph → edit → verify → explain/replan/circuit), loop redirect/autocompact, CodingMetrics, corpus stress — see `docs/coding-engine.md` |
