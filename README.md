...
| **Coding Engine** | `coding/` (PM 0.11) | Live multi-turn path + **coding arena** (hidden-test pass@1 vs reference baseline). See `docs/coding-engine.md` and `docs/coding-north-star.md`. Run: `python scripts/coding_arena.py --smoke` / `--full --vs-baseline`. |
