...
| **Coding Engine** | `coding/` (PM 0.12) | Live multi-turn path + coding arena (mock CI + closed-book LLM path). Index facade, large-repo/protocol smoke. **Does not claim exceeds Claude Code/Codex** — see `docs/coding-north-star.md`. Run: `python scripts/coding_arena.py --smoke`. |
